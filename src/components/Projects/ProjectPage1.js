...
function ProjectPage1() {
    return (
        <Container>
            ...
            <img src={terrain} className="img-fluid" alt="dam comparison" />
            <br /><br /><br /><br />
            ...
            <Row className='project-row-1'>
                ...
                <Col>
                    <img src={road} style={{ width: '100%', height: 'auto' }} />
                </Col>
            </Row>
            <br /><br /><br /><br />
            ...
            <Row className='project-row-1'>
                ...
                <Row>
                    <img src={restaurant} style={{ width: '100%', height: 'auto' }} />
                    <img src={white} style={{ width: '100%', height: 'auto' }} />
                    <img src={gnss} style={{ width: '100%', height: 'auto' }} />
                    <img src={park} style={{ width: '100%', height: 'auto' }} />
                </Row>
            ...
            <Row className='project-row-1'>
                ...
                <Col>
                    <img src={water} style={{ width: '100%', height: 'auto' }} />
                </Col>
            </Row>
            <br /><br /><br /><br />
            ...
            <Row className='project-row-2'>
                ...
                <Row>
                    <img src={cycle} style={{ width: '100%', height: 'auto' }} />
                </Row>
            </Row>
            <br /><br /><br /><br />
            ...
            <Row className='project-row-1'>
                ...
                <Col>
                    <img src={lights} style={{ width: '100%', height: 'auto' }} />
                </Col>
            </Row>
            <br /><br /><br /><br />
            ...
            <Row className='project-row-2'>
                ...
                <Row>
                    <img src={ui} style={{ width: '100%', height: 'auto' }} />
                </Row>
            ...
            <Row className='project-row-2'>
                ...
                <Row>
                    ...
                    <img src={data2} style={{ width: '100%', height: 'auto' }} />
                </Row>
            </Row>
        </Container>
    )
